...
CLIENTID="someSuperLongClientId1234567890"
...
echo "----------------------"
curl $INSTANCE_URL/services/apexrest/get_apps -H 'Authorization: Bearer '$ACCESS_TOKEN
echo
echo "----------------------"
echo
echo "----------------------"
...
echo "----------------------"
curl $INSTANCE_URL/services/apexrest/post_upload/ -H 'Authorization: Bearer '$ACCESS_TOKEN -H 'Content-Type: application/json' -d @session.json
echo
echo "----------------------"
